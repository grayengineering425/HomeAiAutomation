...
/* harmony import */ var _background_index_worker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./background-index.worker */ "./src/worker/app-workers/background-index.worker.ts");
...
var AppWorkers = /** @class */ (function () {
    ...
    AppWorkers.prototype.workerBroker = function ($event) {
        ...
        if (topic == "startIndexLoop")
            this.returnWorkResults(_background_index_worker__WEBPACK_IMPORTED_MODULE_1__["BackgroundIndex"].doWork(workerMessage));
        else if (topic == "endIndexLoop")
            this.inLoop = false;
    };
    AppWorkers.prototype.delay = function (ms) {
        return new Promise(function (resolve) { return setTimeout(resolve, ms); });
    };
    AppWorkers.prototype.returnWorkResults = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var index, modMessage;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!this.inLoop) return [3 /*break*/, 3];
                        if (index > 5)
                            index = 0;
                        console.log('here');
                        modMessage = new _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_2__["WorkerMessage"](message.topic, { start: index });
...
/***/ "./src/worker/app-workers/background-index.worker.ts":
/*!***********************************************************!*\
  !*** ./src/worker/app-workers/background-index.worker.ts ***!
  \***********************************************************/
/*! exports provided: BackgroundIndex */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BackgroundIndex", function() { return BackgroundIndex; });
...
var BackgroundIndex = /** @class */ (function () {
    function BackgroundIndex() {
    }
    BackgroundIndex.doWork = function (value) {
        var count = value.data.start + 1;
        console.log('from worker: ' + count);
        return new _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_0__["WorkerMessage"](value.topic, { iterations: count });
    };
